    ...
    <div class="wrapper">
        <div class="sidebar-wrapper">
            ...
            <div class="profile-container">
                ...
                <h1 class="name">LAKSH SINHA</h1>
                <h3 class="tagline">A STUDENT </h3>
            </div>
            
            <div class="contact-container container-block">
                <ul class="list-unstyled contact-list">
                    <li class="email"><i class="fa fa-envelope"></i>lakshsinha03@gmail.com</li>
            ...
            <div class="education-container container-block">
                ...
                <div class="item">
                    <h4 class="degree">DAV PUBLIC SCHOOL  </h4>
                    <h5 class="meta"></h5>
                    <h5 class="meta"> STUDING AT DAV KOYLA NADAR IN DHANBAD</h5>
                    <div class="time">2012 - -</div>
                </div><!--//item-->
                <div class="item">
                    <h4 class="degree">GOT A CERTIFICATE FROM SPELL BEE iN 4th STANDARD</h4>
                    <h5 class="meta">PARTICIPATE IN SCHOOL EVIBHITION IN 2019</h5>
                    <h5 class="meta">PARTICIPATE IN ATL LAB IN 2021</h5>
                    <div class="time">2012 - 2021</div>
                </div><!--//item-->
